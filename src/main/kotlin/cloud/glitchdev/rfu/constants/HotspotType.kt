...
enum class HotspotType(val displayName: String, val buffMatch: String?, val color: Color) {
    DOUBLE_HOOK("Double Hook", "Double Hook Chance", Color(85, 85, 255, 100)),
    SEA_CREATURE("Sea Creature", "Sea Creature Chance", Color(0, 170, 170, 100)),
    FISHING_SPEED("Fishing Speed", "Fishing Speed", Color(85, 255, 255, 100)),
    UNKNOWN("Unknown", null, Color(255, 255, 255, 100)),
    TROPHY_FISH("Trophy Fish", "Trophy Fish Chance", Color(255, 170, 0, 100)),
    TREASURE("Treasure", "Treasure Chance", Color(255, 255, 85, 100));
